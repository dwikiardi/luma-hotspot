...
class ManagePortalConfig extends Page implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        $this->form->fill([
            ...
            'session_timeout' => $config->session_timeout > 0 ? $this->toSuffix($config->session_timeout) : '24h',
            'idle_timeout' => $config->idle_timeout > 0 ? $this->toSuffix($config->idle_timeout) : null,
